		...
		override public function set changeFactor(n:Number):void {
			...
			if (_orient) {
				...
				while (i--) {
					...
					oldTarget[cotb[2]] = (Math.atan2(dy, dx) * _RAD2DEG + toAdd)*Math.PI/180+Math.PI/2;
//					trace(curVals[cotb[0]],curVals[cotb[1]],_future[cotb[0]],_future[cotb[1]],oldTarget[cotb[2]]*_RAD2DEG);
				}
				_target = oldTarget;
				this.round = oldRound;
				_orient = true;
